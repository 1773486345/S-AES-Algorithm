...
public class S_AES_2 {
    public static String W0,W0_;
    public static String W1,W1_;
    public static String W2,W2_;
    public static String W3,W3_;
    public static String W4,W4_;
    public static String W5,W5_;
    ...
    public static void get_Key(){
        System.out.println("请输入主密匙(32bit):");
    ...
    public static void encrypt(){
        ...
        System.out.println("加密midtext:"+Plainttext);
        ...
        Plainttext=replace(Plainttext,1);//半字节替代
        Plainttext=move_hang(Plainttext);//行移位
        String ciphertext=xor(Plainttext,W4_+W5_);//轮秘钥加
    ...
    public static void decrypt(){
        ...
        System.out.println("解密midtext:"+ciphertext);
